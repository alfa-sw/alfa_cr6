...
def parse_arguments():
    ...
    parser.add_argument('-s', '--app_settings', default='app_settings.production.py', help='default: "%(default)s".')
...
def exec_(cmd_, dry):
    ...
    if not dry:
        os.system(cmd_ + f" > {PROJECT_ROOT}/make.log")
...
def main():
    ...
    logging.warning(f"see log in {PROJECT_ROOT}/make.log")
