...
D = {
    ...
    ",\ncreating {} jars": "{} 의 신규 바코드를 생성하였습니다",
    ...
    "Start dispensing roller": "디스펜싱 롤러 동작",
    "Start input roller to photocell": "바코드 센서쪽으로 이동",
    ...
    # start the movement of the output roller until the related photocell gets engaged
    "Start output roller to photocell dark": "배출구에 있는 센서로 이동",
    # start the movement of the output roller until the related photocell gets unengaged
    "Start output roller to photocell light": "센서에서 배출구 끝까지 이동",
    "Stop  input roller": "투입구 롤러를 정지",
    "Stop  lifter roller": "리프터 롤러를 정지",
    "Stop  lifter": "리프터를 정지",
    "Stop  output roller": "배출구 롤러를 정지",
    "Stop dispensing roller": "디스펜싱 롤러를 정지",
    ...
    # and printing barcodes (it is a second part of the complete message
    # asking to confirm the action of creating new cans and printing related
    # label)
    ...
    "confirm deleting order '{}' and related jars?": "{} 주문을 삭제하고, 어뎁터를 제거하시겠습니까?",
    ...
    "file name": "파일명",
    "file_name:{}": "파일명{}",
    "hit 'OK' to unfreeze it": "재시작하려면, 확인을 눌러주세요",
    "loaded:": "로딩 완료",
    "loading:": "로딩중",
    "machine_head:{}\n": "모듈 {}\n",
    "move 00 01 ('feed')": "0번에서 1번으로 어뎁터 이동",
    "move 01 02 ('IN -> A')": "(IN->A) 어뎁터 이동",
    "move 02 03 ('A -> B')": "(A->B) 어뎁터 이동",
    "move 02 04 ('A -> C')": "(A->C) 어뎁터 이동",
    "move 03 04 ('B -> C')": "(B->C) 어뎁터 이동",
    "move 04 05 ('C -> UP')": "(C->UP) 어뎁터 이동",
    "move 04 05 ('DOWN -> D')": "('리프터 하단 -> D') 어뎁터 이동",
    "move 04 05 ('UP -> DOWN')": "(리프터 상단 -> 리프터 하단) 어뎁터 이동 ",
    "move 05 06 ('UP -> DOWN')": "('리프터 상단 -> 리프터 하단') 어뎁터 이동",
    "move 06 07 ('DOWN -> D')": "(리프터 하단 -> D) 어뎁터 이동",
    "move 07 08 ('D -> E')": "(D -> E) 어뎁터 이동",
    "move 07 09 ('D -> F')": "(D -> F) 어뎁터 이동",
    "move 08 09 ('E -> F')": "(E -> F) 어뎁터 이동",
