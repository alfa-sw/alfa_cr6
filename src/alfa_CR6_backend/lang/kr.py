D = {
    " ?":    " ?",
    " before dispensing. Please check jar.": "추출하기 전에 캔을 확인하십시오.",
    ",\ncreating {} jars":    ", \ n {} 캔 만들기",
    "CAN PRESENCE":    "CAN PRESENCE",
    "Cancel": "취소",
    "Carousel OK":    "A자동화가 실행 중입니다.",
    "Carousel Paused":    "자동화 일시 중지됨",
    "Condition not valid while reading barcode:{}":   "바코드를 읽는 동안 유효하지 않은 조건 : {}",
    "DISPENSING POSITION PHOTOCELL":    "디스 펜싱 위치 포토 셀",
    "INPUT ROLLER PHOTOCELL":    "INPUT ROLLER PHOTOCELL",
    "Jar volume not sufficient for barcode:{}.\nPlease, remove it.\n": "분유를 분배하기에 충분하지 않은 볼륨 : {}. \ n 제발, 제거하십시오. \ n",
    ...
    "OUTPUT ROLLER PHOTOCELL": "출력 롤러 포토 셀",
    "OK": "확인",
    "STEP {} +":    "STEP {} +",
    "STEP {} -":    "STEP {} -",
    ...
    "confirm discarding changes?":    "변경 사항 취소를 확인 하시겠습니까?",
    "confirm freezing carousel?":     "자동화 일시 중지를 확인 하시겠습니까?", 
    "confirm printing {} barcodes?":  "{} 바코드 인쇄를 확인 하시겠습니까?",   
    "confirm saving changes":         "변경 사항 저장 확인",                 
    "confirm unfreezing carousel?":   "자동화 재시작을 확인 하시겠습니까?",    
    "copy": "copy",
